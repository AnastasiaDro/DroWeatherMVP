...
public class WeekDataPresenter {
    ...
    //массив для текстВью первого дня
    ...
    //массив для текствью для второго дня
    ...
    //массив для текстВью третьего дня
    ...
    private String[] takeDayDataArr(String[] dayMorArr, String [] dayAftArr, String [] dayEvArr){
        ...
        //первым идёт время
        dataForTVArr[0] = dayMorArr[Constants.TIME_KEY_IN_WEATHERDATA_ARRAY].substring(0, 10);
        //вторым температура утром
        dataForTVArr[1] = dayMorArr[Constants.TEMP_KEY_IN_WEATHERDATA_ARRAY].concat(" \u2103");
        //третьим температура днем
        dataForTVArr[2] = dayAftArr[Constants.TEMP_KEY_IN_WEATHERDATA_ARRAY].concat(" \u2103");
        //четвертым - температура вечером
        dataForTVArr[3] = dayEvArr[Constants.TEMP_KEY_IN_WEATHERDATA_ARRAY].concat(" \u2103");
        return dataForTVArr;
    }
